 ...
 */
public class ProiezionistaChangeProjectionPanel extends JPanel {
    ...
    public ProiezionistaChangeProjectionPanel(SelezioneProjectionCallBack selezioneProjectionCallBack, TcpClient tcpClient) {
